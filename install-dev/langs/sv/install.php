...
return array(
    ...
    'translations' => array(
        'An SQL error occurred for entity <i>%1$s</i>: <i>%2$s</i>' => 'Ett SQL-fel uppstod för enheten <i>%1$s</i>: <i>%2$s</i>',
        'Cannot create image "%1$s" for entity "%2$s"' => 'Kan inte skapa bild "%1$s för enheten "%2$s"',
        ...
        'SQL error on query <i>%s</i>' => 'SQL fel I fråga <i>%s</i>',
        ...
        'This e-mail address is invalid' => 'Denna E-postadressen är felaktig!',
        ...
        'PHP 5.1.2 or later is not enabled' => 'PHP 5.1.2 eller senare är inte aktiverad',
        'Cannot upload files' => 'Kan inte ladda upp fil',
        'Cannot create new files and folders' => 'Kan inte skapa nya filer och kataloger',
        'GD library is not installed' => 'Biblioteket är inte installerat',
        ...
        'Optional - You can add you logo at a later time.' => 'Valfri - Du kan lägga till en logotyp senare.',
        'Your Account' => 'Ditt konto',
        'First name' => 'Förnamn',
        'Last name' => 'Efternamn',
        'E-mail address' => 'E-postadress',
        'This email address will be your username to access your store\'s back office.' => 'Den här mailadressen kommer att vara det användarnamn du loggar in med i administrationsdelen.',
        ...
        'PrestaShop Installation Assistant' => 'PrestaShop Installationsassistenten',
        'Forum' => 'Forum',
        'Blog' => 'Blogg',
        'Contact us!' => 'Kontakta oss!',
        ...
        'If you have any questions, please visit our <a href="%1$s" target="_blank">documentation</a> and <a href="%2$s" target="_blank">community forum</a>.' => 'Om du har frågor, besök vår <a href="%1$s" target="_blank">dokumentation</a> och <a href="%2$s" target="_blank">forum</a>.',
        ...
        'Installing PrestaShop is quick and easy. In just a few moments, you will become part of a community consisting of more than 250,000 merchants. You are on the way to creating your own unique online store that you can manage easily every day.' => 'Att installera PrestaShop går snabbt och är enkelt. På bara några få steg blir du en del av communityt som består av mer än 250,000 e-handlare. Du är på väg att skapa din egen unika E-butik som du enkelt administrerar varje dag.',
    ),
);
