...
return array(
    ...
    'translations' => array(
        'An SQL error occurred for entity <i>%1$s</i>: <i>%2$s</i>' => 'Ett SQL fel uppstod för enhet <i>%1$s</i>: <i>%2$s</i>',
        'Cannot create image "%1$s" for entity "%2$s"' => 'Kan inte skapa bild "%1$s för enhet "%2$s"',
        ...
        'SQL error on query <i>%s</i>' => 'SQL fel i query <i>%s</i>',
